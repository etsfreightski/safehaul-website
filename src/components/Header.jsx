      ...
      <nav className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-40">
          ...
          <div className="hidden md:flex items-center space-x-6 ml-0">
            ...
            <Link to="/archive" className="text-lg font-semibold text-gray-900 hover:text-[#40CBB5] transition-colors drop-shadow-md">News Archive</Link>
            <button 
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute left-0 right-0 bg-white shadow-lg p-6 z-50">
            <div className="flex flex-col space-y-6">
              ...
              <Link to="/archive" className="text-base font-semibold text-gray-900 hover:text-[#40CBB5] transition-colors">News Archive</Link>
              <button 
                onClick={() => scrollToSection('contact')}
