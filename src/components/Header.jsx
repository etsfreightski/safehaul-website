      ...
      <nav className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-40">
          ...
          <div className="hidden md:flex items-center space-x-4 ml-0">
            ...
            <button onClick={() => scrollToSection('subscriptions')} className="text-base font-semibold text-gray-900 hover:text-[#40CBB5] transition-colors drop-shadow-md flex items-center whitespace-nowrap">
              <span className="text-[#FFB951] mr-1 text-lg drop-shadow-lg">★</span>
              Subscriptions
              <span className="text-[#FFB951] ml-1 text-lg drop-shadow-lg">★</span>
            </button>
            <button onClick={() => scrollToSection('why-us')} className="text-base font-semibold text-gray-900 hover:text-[#40CBB5] transition-colors drop-shadow-md whitespace-nowrap">Why Us</button>
            ...
            <Link to="/risk-assessment" className="text-base font-semibold text-gray-900 hover:text-[#40CBB5] transition-colors drop-shadow-md whitespace-nowrap">Risk Assessment</Link>
